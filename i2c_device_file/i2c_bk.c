...
static int ds3231_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if ((data->class = class_create(THIS_MODULE,"i2cdriverbk")) == NULL)
	{
		...
		printk(KERN_INFO"Class creation successful\n");
	if(device_create(data->class, NULL, data->dev, NULL, "i2c_drv%d",0) == NULL)
	{
		...
		printk(KERN_INFO"Device creation successful\n");
...
{
	printk("Init called module loaded\n");
